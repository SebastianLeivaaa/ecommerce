  ...
  "inline-flex items-center rounded-md border border-neutral-200 px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:border-neutral-800 dark:focus:ring-neutral-300",
  {
    variants: {
      variant: {
        ...
        green: 
          "border-transparent bg-green-700 text-neutral-50 shadow hover:bg-green-600/80 dark:bg-green-600 dark:text-neutral-50 dark:hover:bg-green-600/80",
        red:
          "border-transparent bg-red-700 text-neutral-50 shadow hover:bg-red-600/80 dark:bg-red-700 dark:text-neutral-50 dark:hover:bg-red-700/80",
        yellow:
          "border-transparent bg-yellow-600 text-neutral-50 shadow hover:bg-yellow-600/80 dark:bg-yellow-600 dark:text-neutral-50 dark:hover:bg-yellow-600/80"
      },
    },
    defaultVariants: {
      variant: "default",
